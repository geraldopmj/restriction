...
"" ""
PENS
"Upper" 1.0 0 -15575016 true "" "plot upperClass"
"Middle" 1.0 0 -7171555 true "" "plot middleClass"
"Lower" 1.0 0 -8053223 true "" "plot lowerClass"
"75%" 1.0 0 -16777216 true "" "plot 75"
"50%" 1.0 0 -9276814 true "" "plot 50"
"25%" 1.0 0 -12895429 true "" "plot 25"
...
198
173
Patch Ratio | Lower:Middle:Upper
patchRatio
0
1
11
...
1054
428
Note to graph above:\nClass is defined after the calculation of median of total resources of all turtles.\nIf turtle has resource deviation of more than 0.44 of median it is classified as upper or lower. The middle index can be used as an equality index since the more turtles is in median range, the less the resource distribution deviation.
12
0.0
1
